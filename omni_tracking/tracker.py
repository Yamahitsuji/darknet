...
class Tracker:
    ...
    def __init__(self, img_w: int, img_h: int, metric: NearestNeighborDistanceMetric, max_iou_distance: float = 0.7,
                 max_age: int = 30, n_init: int = 3) -> None:
        self.img_w = img_w
        self.img_h = img_h
        self.metric = metric
    ...
    def _match(self, detections: List[Detection]) -> Tuple[List[Tuple[int, int]], List[int], List[int]]:
        ...
        def gated_metric(tracks: List[Track], dets: List[Detection], track_indices: List[int],
